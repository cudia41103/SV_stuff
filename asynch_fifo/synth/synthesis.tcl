...
set design_clock_pin clk1
set design_clock_pin clk2
set design_reset_pin rst1
set design_reset_pin rst2
...
#clk1 configuration
set clk1_name $design_clock_pin
set clk1_period 2
create_clock -period $clk1_period -name my_clk1 $clk1_name
set_fix_hold [get_clocks my_clk1]

set_input_delay 0.5 [all_inputs] -clock my_clk1
set_output_delay 0.5 [all_outputs] -clock my_clk1
set_load 0.1 [all_outputs]
set_max_fanout 1 [all_inputs]
set_fanout_load 8 [all_outputs]

set clk2_name $design_clock_pin
set clk2_period 4
create_clock -period $clk2_period -name my_clk2 $clk2_name
set_fix_hold [get_clocks my_clk2]

set_input_delay 0.5 [all_inputs] -clock my_clk2
set_output_delay 0.5 [all_outputs] -clock my_clk2
set_load 0.1 [all_outputs]
set_max_fanout 1 [all_inputs]
set_fanout_load 8 [all_outputs]
